        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยอินทุอร สรแสง</p>
              <hr />
              {/* Post Content */}
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "dicimal" }}>
                  <li>
              ...
              <p>
                ลักษณะสำคัญของการพัฒนาองค์การ มีดังนี้ คือ
                <ul className="ml-4" style={{ listStyle: "decmal" }}>
                  <li>
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyle: "decmal" }}>
                  <li>
                    ...
                    เช่น จิตวิทยา จิตวิทยาสังคม สังคมวิทยา รัฐศาสตร์
                    เศรษฐศาสตร์ปรัชญา ศาสนา ฟิสิกส์และชีววิทยา เป็นต้น
                  </li>
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyle: "decmal" }}>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "square" }}>
                    <li>
                      ส่วน CM
                      ประยุกต์วิธีการแก้ปัญหาอย่างมีเหตุผลในการทำให้เป้าหมายที่ต้องการบรรลุผลส่วน
                    </li>
                  </ul>
                  <li>
                ...
                <ul className="ml-4" style={{ listStyle: "decmal" }}>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "disc" }}>
                    <li>
                      ...
                      รูปแบบการจัดการแบบมีส่วนร่วม หลักการของตาข่าย (เครือข่าย)
                    </li>
                  </ul>
                  <li>
                ...
                <ul className="ml-4" style={{ listStyle: "decimal" }}>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                    ...
                    <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                      <li>
                        ...
                        เช่น -พันธกิจ ค่านิยม
                        -ความเป็นมา-โครงสร้างองค์การ-สินค้าและบริการ-ความคาดหวังขององค์การ-ประสบการณ์ขององค์การ
                      </li>
                      <li>
                        การรวบรวมข้อมูลขององค์การได้จาก-การสังเกตพฤติกรรมการทำงาน-การสัมภาษณ์-การสำรวจความคิดเห็นด้วยแบบสอบถาม-การศึกษาข้อมูลจากเอกสารขององค์การ
                      </li>
                    </ul>
                    ...
                    <ul className="ml-4" style={{ listStyleType: "disc" }}>
                      ...
                      <li>
                        กฎกติกาในการดำเนินโครงการ (Ground Rules)การรักษาความลับ
                        แนวทางการตัดสินใจแต่ละฝ่ายที่มีความเห็นไม่ตรงกัน
                      </li>
                    </ul>
                    <li>
                      {" "}
                      การวินิจฉัยระบบ (Diagnosing) ด้วย McKinsey’s 7S Mode
                    </li>
                    <li>
                  ...
                  <li>
                    ...
                    <ul style={{ listStyleType: "decimal" }} className="ml-4">
                      <li>
                        การเบี่ยงเบนเชิงลบ (Negative
                        Deviance)สถานะไม่สามารถปฏิบัติหน้าที่ได้ตามปกติ
                        (Dysfucntion State){" "}
                      </li>
                      <li>ปกติ (Ordinary)</li>
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyle: "decimal" }}>
                  ...
                  คือการดำเนินการเปลี่ยนแปลงตามที่วางแผนไว้ ได้แก่1.
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyle: "decimal" }}>
                  <li>
                    ...
                    ได้แก่ประธาน รองประธานอาวุโส ผู้จัดการ พนักงาน ฯลฯ
