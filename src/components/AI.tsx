          ...
          <div className=" lg:w-2/3 w-full">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              <ol style={{ listStyleType: "disc" }} className="ml-4">
                <li>
                  ถ้าผลการพยากรณ์เป็น lung_aca หมายความว่าเป็นโรคมะเร็งปอด aca
                </li>
                <li>
                  ถ้าผลการพยากรณ์เป็น lung_bnt
                  หมายความว่าเป็นปกติไม่เป็นโรคมะเร็งปอด aca
                </li>
                <li>
                  ถ้าผลการพยากรณ์เป็น lung_scc หมายความว่าเป็นโรคมะเร็งปอด scc
                </li>
              </ol>
            </p>
